...
class ParserDescription(runtime.Parser):
    ...
    def ClauseD(self, rule,tokens, _parent=None):
        ...
        if _token == 'STR':
            ...
            STMT = self._scan('STMT', context=_context)
            return parsetree.Eval(rule, STMT.value[2:-2])
